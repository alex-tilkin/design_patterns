package unit_22_strategy.solution;
...
class QuadraticEquationSolver {
	...
	public Pair<Complex, Complex> solve(double a, double b, double c) {
		double determinant = this.strategy.calculateDiscriminant(a, b, c);
		double sqrt = Math.sqrt(determinant);

		Pair p = new Pair((-b + sqrt) / (2 * a), (-b - sqrt) / (2 * a));
...
public class StrategyExerciseSolution {

	public static void main(String[] args) {
		double a = 5;
		double b = 3;
		double c = 2;
		QuadraticEquationSolver q = new QuadraticEquationSolver(new RealDiscriminantStrategy());
		Pair p = q.solve(a, b, c);
