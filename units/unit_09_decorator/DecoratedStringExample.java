...
class DecoratedString {
	...
	public DecoratedString(String string) {
		this.string = string;
	}
	
	public long getNumberOfVowls() {
...
public class DecoratedStringExample {

	public static void main(String[] args) {
		DecoratedString decoratedString = new DecoratedString("Hi, my name is slim shady");
		
		System.out.println(decoratedString.getNumberOfVowls());
	}
}
